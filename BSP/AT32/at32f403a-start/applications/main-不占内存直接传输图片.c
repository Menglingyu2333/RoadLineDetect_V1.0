...
u8  ImageBuf[ImageWidth][ImageHeight];
...
//        RGB_PixelBuf_16b|=(OV2640_DATA)<<8;
        ...
        RGB_PixelBuf_16b=yuv_8_to_RGBGray(RGB_PixelBuf_16b);
//        RGB_PixelBuf_16b=yuv422_y_to_bitmap(90,RGB_PixelBuf_16b);
...
//     LCD_Drawbmp16(0,0,ImageWidth,ImageHeight,ov2640_framebuf);
    }

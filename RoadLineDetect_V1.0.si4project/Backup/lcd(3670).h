...
#define	LCD_CS_SET  GPIOC->BSRR=1<<10    //片选端口  	PC9
#define	LCD_RS_SET	GPIOC->BSRR=1<<0    //数据/命令  	PC8	   
#define	LCD_WR_SET	GPIOC->BSRR=1<<1    //写数据		PC7
#define	LCD_RD_SET	GPIOC->BSRR=1<<2    //读数据		PC6
#define	LCD_RST_SET	GPIOC->BSRR=1<<3    //复位			PC5
								    
#define	LCD_CS_CLR  GPIOC->BRR=1<<10    //片选端口  	PC9
#define	LCD_RS_CLR	GPIOC->BRR=1<<0     //数据/命令  	PC8	   
#define	LCD_WR_CLR	GPIOC->BRR=1<<1     //写数据		PC7
#define	LCD_RD_CLR	GPIOC->BRR=1<<2     //读数据		PC6
#define	LCD_RST_CLR	GPIOC->BRR=1<<3    //复位			PC5								    
